...
import { Mail, Send, Copy, Plus, Mic } from 'lucide-react';
...
export default function AIChatPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      const aiResponse = `Subject: Welcome to Mailora - Let's Get Started!

Dear [Name],

Welcome to Mailora! We're thrilled to have you join our community of professionals who are revolutionizing their email communication with the power of artificial intelligence.
